...
#define AP_SSID "RoboCar-A-Config"
...
void start_mdns_service()
{
    ...
    char device_id[32];
    // 格式: robocar-a-v1-xxx (取 MAC 地址最后 3 位)
    ...
    mdns_service_add(instance_name, "_robocar", "_tcp", 80, serviceTxtData, 2);
    ESP_LOGI(TAG, "mDNS service started. Hostname: robocar.local, ID: %s", device_id);
}
